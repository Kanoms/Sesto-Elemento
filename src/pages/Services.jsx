...
const servicesData = {
  ...
  technicalSiteAsst: {
    ...
    paragraph:
      "All Customers are invited to benefit from our customer technical assistance either onsite or offsite in order to provide better services. Responding to domestic and international customers’ inquiries in a short time, and accurate transfer of customers’ demand to the related department. Customers can benefit from technical services in 3 main categories: Before Sales, During sales, After Sales. We provide the following services: • Inspection • Installation – Electrical and Instrument • Equipment Commissioning & Decommissioning • Various Surveys Services • Supply and erection of scaffolding • Marine Services • Equipment rental • Permanent and Temporary site accommodation.",
  },
  equipmentLease: {
    image: equipmentleaseImage,
    header: "Equipment Lease",
    paragraph:
      "We are aware that having the right equipment is essential for the seamless execution of your projects. We offer a comprehensive range of equipment lease options tailored to meet your specific needs, ensuring that you have access to the tools necessary to drive efficiency and productivity. Our extensive fleet of state-of-the-art equipment is meticulously maintained and regularly serviced to deliver exceptional performance and reliability. From heavy machinery to specialized tools, we have the resources to support a wide range of industries and project requirements.",
  },
};
